...
public class CustomerStatementController {
	...
	Logger log = LoggerFactory.getLogger(CustomerStatementController.class);
	...
	public ResponseEntity<?> processCustomerStatement(@RequestBody List<CustomerStatement> customerStatements) {

		try {
			log.info("#######Starting execution of processCustomerRecord()######", CustomerStatementController.class);
			...
			// Generates Bad Request as a response,
			...
			log.info("#######Execution completed for processCustomerRecord() ... Generating Response ######",
					CustomerStatementController.class);
			// This code block is used to throw Internal Server Error when account name =
